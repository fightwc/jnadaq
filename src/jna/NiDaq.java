...
public class NiDaq {
	...
	public Pointer createTask(String taskName) throws NiDaqException {
		byte[] btName = taskName.getBytes(StandardCharsets.US_ASCII);
	...
	public void createDOChan(Pointer taskHandle, String lines, String nameToAssignToLines, int lineGrouping) throws NiDaqException {
		checkError(Nicaiu.INSTANCE.DAQmxCreateDOChan(taskHandle, lines.getBytes(StandardCharsets.US_ASCII), nameToAssignToLines.getBytes(StandardCharsets.US_ASCII), lineGrouping));
	}
	...
	public void createDIChan(Pointer taskHandle, String lines, String nameToAssignToLines, int lineGrouping) throws NiDaqException {
		checkError(Nicaiu.INSTANCE.DAQmxCreateDIChan(taskHandle, lines.getBytes(StandardCharsets.US_ASCII), nameToAssignToLines.getBytes(StandardCharsets.US_ASCII), lineGrouping));
	}
	...
	public void createAIVoltageChannel(Pointer taskHandle, String physicalChannel, String nameToAssignToChannel, int terminalConfig, double minVal, double maxVal, int units, String customScaleName) throws NiDaqException {
		checkError(Nicaiu.INSTANCE.DAQmxCreateAIVoltageChan(taskHandle, physicalChannel.getBytes(StandardCharsets.US_ASCII), nameToAssignToChannel.getBytes(StandardCharsets.US_ASCII), terminalConfig, minVal, maxVal, units, customScaleName == null ? null : customScaleName.getBytes(StandardCharsets.US_ASCII)));
	}
	...
	public void createAICurrentChannel(Pointer taskHandle, String physicalChannel, String nameToAssignToChannel, int terminalConfig, double minVal, double maxVal, int units, int shuntResistorLoc, double extShuntResistorVal, String customScaleName) throws NiDaqException {
		checkError(Nicaiu.INSTANCE.DAQmxCreateAICurrentChan(taskHandle, physicalChannel.getBytes(StandardCharsets.US_ASCII), nameToAssignToChannel.getBytes(StandardCharsets.US_ASCII), terminalConfig, minVal, maxVal, units, shuntResistorLoc, extShuntResistorVal, customScaleName.getBytes(StandardCharsets.US_ASCII)));
	}
	...
	public void cfgSampClkTiming(Pointer taskHandle, String source, double rate, int activeEdge, int sampleMode, long sampsPerChan) throws NiDaqException{
		checkError(Nicaiu.INSTANCE.DAQmxCfgSampClkTiming(taskHandle, source.getBytes(StandardCharsets.US_ASCII), rate, activeEdge, sampleMode, sampsPerChan));
	}
	...
	public void resetDevice(String devName) throws NiDaqException {
		checkError(Nicaiu.INSTANCE.DAQmxResetDevice(devName.getBytes(StandardCharsets.US_ASCII)));
	}
